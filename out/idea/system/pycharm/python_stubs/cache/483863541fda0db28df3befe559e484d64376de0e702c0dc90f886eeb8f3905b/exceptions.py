...
class BaseException(object):
    ...
    __dict__ = None # (!) real value is "dict_proxy({'__setattr__': <slot wrapper '__setattr__' of 'exceptions.BaseException' objects>, '__getslice__': <slot wrapper '__getslice__' of 'exceptions.BaseException' objects>, '__getitem__': <slot wrapper '__getitem__' of 'exceptions.BaseException' objects>, '__setstate__': <method '__setstate__' of 'exceptions.BaseException' objects>, '__reduce__': <method '__reduce__' of 'exceptions.BaseException' objects>, '__str__': <slot wrapper '__str__' of 'exceptions.BaseException' objects>, 'args': <attribute 'args' of 'exceptions.BaseException' objects>, '__getattribute__': <slot wrapper '__getattribute__' of 'exceptions.BaseException' objects>, '__unicode__': <method '__unicode__' of 'exceptions.BaseException' objects>, '__delattr__': <slot wrapper '__delattr__' of 'exceptions.BaseException' objects>, '__repr__': <slot wrapper '__repr__' of 'exceptions.BaseException' objects>, '__dict__': <attribute '__dict__' of 'exceptions.BaseException' objects>, 'message': <attribute 'message' of 'exceptions.BaseException' objects>, '__doc__': 'Common base class for all exceptions', '__init__': <slot wrapper '__init__' of 'exceptions.BaseException' objects>, '__new__': <built-in method __new__ of type object at 0x000000005DBF5730>})"
