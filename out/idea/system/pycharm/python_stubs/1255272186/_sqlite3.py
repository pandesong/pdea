# encoding: utf-8
# module _sqlite3
# from D:\Python27\DLLs\_sqlite3.pyd
# by generator 1.147
# no doc
...
adapters = {
    (
        ...
        None # (!) real value is '<function adapt_date at 0x00000000032DA278>'
    ,
    (
        None, # (!) real value is "<type 'datetime.datetime'>"
        '<value is a self-reference, replaced by this string>',
    ): 
        None # (!) real value is '<function adapt_datetime at 0x00000000032DA2E8>'
    ,
}

converters = {
    'DATE': None, # (!) real value is '<function convert_date at 0x00000000032DA358>'
    'TIMESTAMP': None, # (!) real value is '<function convert_timestamp at 0x00000000032DA3C8>'
}
